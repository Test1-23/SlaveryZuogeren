...
function getDB () {
  ...
  _db.exec(`
    CREATE TABLE IF NOT EXISTS bot_configs (
      ...
      host TEXT NOT NULL DEFAULT '${defaults.host}',
      port INTEGER NOT NULL DEFAULT ${defaults.port},
      version TEXT DEFAULT '${defaults.version}',
      auth TEXT NOT NULL DEFAULT '${defaults.auth}',
      username TEXT NOT NULL DEFAULT '${defaults.username}',
